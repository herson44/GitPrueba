...
Population size can be an estimation if you believe that population is big, beacuse estandard error varies just tiny amounts by vaiations in simple size if population is big. 

How much is big? Take for example 100,000.
